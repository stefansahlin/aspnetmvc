        ...
        public ActionResult NewDetails(int id = 0, string message = null)
        {
            if (Request.IsAuthenticated)
            {
                ...
                {              
                    ...
                    if (myweather == null)
                    {
                        //Ändra till någon sorts errorsida här.
                ...
                catch
                {
                    ...
                    return RedirectToAction("Index", "MyPlaces", new { message = userMessage }); //skriv om hämtningen till yr till en dum sträng och se om den hamnar här.
                    //return RedirectToAction("Index", "MyPlaces"); //Med userMessage
                }
            }
            return RedirectToAction("LogIn", "Account");
        }
