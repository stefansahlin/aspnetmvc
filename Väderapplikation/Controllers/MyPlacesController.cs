    ...
    public class MyPlacesController : Controller
    {
        ...
        public ActionResult NewCreate(ViewModel model)
        {
            if (Request.IsAuthenticated)
            {
                ...
                { 
                MyPlace myweather = new MyPlace();//platsen som hämtas ut från databasen.
                ...
                //var yrCoordinates = placeService2.GetYrCoordinates(place, region);
               ...
               // myweather.longitude = decimal.Parse(yrCoordinates[0], System.Globalization.CultureInfo.InvariantCulture);
               // myweather.latitude = decimal.Parse(yrCoordinates[1], System.Globalization.CultureInfo.InvariantCulture);
